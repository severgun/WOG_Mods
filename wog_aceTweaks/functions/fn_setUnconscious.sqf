...
// #include "script_component.hpp" // ACE3 3.12.1 orig
#include "\z\ace\addons\medical\script_component.hpp" // WOG Tweak

//#define DEFAULT_DELAY (round(random(10)+5)) // ACE3 3.12.1 orig
#define DEFAULT_DELAY (round(random[20,60,100])) // WOG Tweak
